...
app.get("/jokes/:id" , (req, res) => {
  ...
  const jokesFound = jokes.find((joke) => joke.id === id);
  res.json(jokesFound);
})
...
app.get("/filter", (req, res) => {
  ...
  const filteredActivities = jokes.filter((filterJoke) => filterJoke.jokeType === type);
...
app.put("/jokes/:id", (req, res) => {
  ...
  const searchIndex = jokes.findIndex((replaceJoke) => replaceJoke.id === id );
