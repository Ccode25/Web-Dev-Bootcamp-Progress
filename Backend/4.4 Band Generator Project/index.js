...
function generateBandname(req, res, next) {
  let randomNumber = Math.floor(Math.random() * adj.length);
  let randomAdj = adj[randomNumber]
  let randomNoun = noun[randomNumber]
  req.randomAdj = randomAdj
  req.randomNoun = randomNoun
  next()
  }
...
app.post("/submit",generateBandname, (req, res) => {
  ...
  res.render("index.ejs", {adjective: req.randomAdj, noun: req.randomNoun});
});
